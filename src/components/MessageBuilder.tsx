  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-1">
        {([
          { action: 'bold' as FormatAction, icon: TextB, label: 'عريض *نص*' },
          { action: 'italic' as FormatAction, icon: TextItalic, label: 'مائل _نص_' },
          { action: 'strike' as FormatAction, icon: TextStrikethrough, label: 'مشطوب ~نص~' },
          { action: 'mono' as FormatAction, icon: Code, label: 'أحادي المسافة ```نص```' },
      ...
      {preview && (
        <div style={{
          ...
          <div style={{
            ...
            معاينة واتساب — {previewLead?.name || 'العميل'}
          </div>
          ...
          <div style={{
            ...
            {/* Tail (SVG to avoid false positive AI slop detection) */}
            <svg
              viewBox="0 0 8 13"
              style={{
                position: 'absolute',
